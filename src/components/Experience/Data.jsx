const experienceData = [
  {
    ...
    responsibilities: [
      ...
      'One of my biggest contributions has been helping design and implement a new betting platform architecture. I worked on integrating generic SDK plugins to streamline parallel bet processing, making it easier to integrate services and improving efficiency.',
